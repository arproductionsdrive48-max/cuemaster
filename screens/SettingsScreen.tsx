          ...
          <div className="glass-card overflow-hidden">
            <button
              onClick={() => {
                ...
                localStorage.setItem('cuemaster-theme', next ? 'dark' : 'light');
              }}
              className="w-full p-4 flex items-center gap-4 hover:bg-accent/30 transition-colors border-b border-border/50">
                ...
                {(['12h', '24h'] as const).map(fmt => (
                  <button
                    ...
                    onClick={() => {
                      ...
                      localStorage.setItem('cuemaster-timeformat', fmt);
            ...
            <div className="p-4">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  localStorage.setItem('cuemaster-timezone', e.target.value);
